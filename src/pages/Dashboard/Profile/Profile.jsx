                ...
                <div className="flex sm:justify-between flex-col sm:flex-row  w-full absolute sm:top-[120px] top-[100px] lg:px-10 px-4 items-center">
                    <div className="flex sm:w-3/4 sm:flex-row flex-col items-center sm:gap-5">
                        ...
                        <div className="flex flex-col  gap-1 sm:items-start items-center md:pt-8">
                            {profile && <div className="text-black font-bold lg:text-[32px] text-[32px] sm:text-[20px]  cursor-pointer">{profile.userName}</div>}
                        ...
                        (
                            <div className="flex sm:gap-5 gap-2 sm:w-1/2 w-full  pt-3 justify-end sm:flex-row flex-col">
                                <Button
                                    ...
                                    className="lg:w-[140px] sm:w-[37px] w-full bg-[#007AFF] h-[37px] rounded-lg hover:bg-[#006ee6] transition-all duration-150 md:text-base text-white text-[16px] px-2" hide leftIcon={<MdAdd />}>Thêm bạn bè</Button>
                                <div className="flex gap-1">
                                    <Button
                                        className="lg:w-[130px] sm:w-[37px]  w-full bg-[#E4E6EB] h-[37px] rounded-lg hover:bg-[#CCD0D5] transition-all duration-150 md:text-base text-[16px] text-black px-2" hide leftIcon={<AiFillMessage />}>Nhắn tin</Button>
                                    <Button className="w-[37px] bg-[#E4E6EB] h-[37px] transition-all duration-150 md:text-base text-[16px] text-black rounded-lg block sm:hidden"> <MdKeyboardArrowDown /></Button>
                                </div>
                            </div>
                        )}
