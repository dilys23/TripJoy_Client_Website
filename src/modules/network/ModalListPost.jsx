...
function ModalListPost({ onClose }) {
    ...
    return (
        <>
            ...
            >
                <div
                    className="modal w-[650px] h-[629px] flex  border-2 border-none rounded-xl shadow-xl stroke-2 bg-white stroke-[#D7D7D7] flex-col items-center"
                    onClick={(e) => e.stopPropagation()}
                >
                    <div className="flex justify-between w-full px-5 py-3 items-center">
                        <div></div>
                        <div className="nunito-text font-extrabold text-[25px] pt-3 mb-2">Danh sách chuyến đi </div>
