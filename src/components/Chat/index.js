...
//     const fetchMessage = async (isLoadMore = false) => {
//         if (loading || !currentRoom || !hasMore) return;
//         try {
//             setLoading(true);
...
//                     isLoadMore ? [...prevMessages, ...newMessages] : [...prevMessages, ...newMessages]
//                 );
...
//             messagesContainerRef.current.scrollTop <= 250 && // Kiểm tra cuộn lên quá 200px
//             hasMore
//         ) {
...
//     }, [])
//     useEffect(() => {
//         // Sau khi tin nhắn thay đổi, cuộn xuống dưới
...
//                 className="w-full h-[230px] bg-[#f4f4f4] flex px-2 py-1 overflow-auto custom-scroll flex-col-reverse">
