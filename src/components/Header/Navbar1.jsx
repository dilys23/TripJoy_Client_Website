        ...
        <div className="mt-[-7px] flex w-full flex-wrap items-center justify-between px-2">
          {isLogin ? (
            <div className="flex w-full">
              ...
              <Search></Search>
              <ul className="z-50 ml-[170px] mt-2 max-lg:fixed hidden max-lg:left-0 max-lg:top-0 max-lg:h-full max-lg:w-2/3 max-lg:min-w-[300px] max-lg:space-y-3 max-lg:overflow-auto max-lg:bg-[#151d20] max-lg:px-10 max-lg:py-4 max-lg:shadow-md lg:!flex lg:gap-x-12">
              ...
              {/* <ul className=" ml-[250px] mt-2 flex gap-16">
                {menuItems.map((item, index) => (
                  <li key={index} className="px-3 max-lg:border-b max-lg:py-3">
                    <a
                      href={item.href}
                      className="text-gray-300 flex flex-col items-center gap-1 text-base hover:text-blue-600"
                    >
                      {item.icon}
                    </a>
                  </li>
