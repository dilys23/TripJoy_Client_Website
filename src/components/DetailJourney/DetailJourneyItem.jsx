        ...
        <div className="w-full md:gap-5 gap-2 flex h-[171px]" >
            ...
            <div className="flex flex-col w-full h-full">
                ...
                <div className="flex w-full md:h-[150px] h-[130px] bg-white rounded-xl shadow-lg border border-[#CCD0D5] px-2 py-2 md:gap-3 gap-[6px]">
                    <img src={journey.image} alt="" className="w-1/6 md:min-w-[120px]  min-w-[77px] object-cover md:h-full h-full rounded-xl" />
                    <div className="flex w-5/6 flex-col md:px-2 gap-1">
                        ...
                        <div className="w-full flex md:gap-5">
                            {journey.category === 1 && <div className="flex px-3 text-[#0F3E4A] bg-[#FFEDE8] border border-[#FDDFDF] hover:bg-[#fee5de] duration-200 md:text-[12px] text-[9px] font-bold rounded-[20px] py-1 cursor-pointer">Ăn uống</div>}
                            {journey.category === 0 && <div className="flex px-3 text-[#0F3E4A] bg-[#D9FFF1] border border-[#A0FFD7] hover:bg-[#c5f7e5] duration-200 md:text-[12px] text-[9px]  font-bold rounded-[20px] py-1 cursor-pointer">Địa điểm du lịch</div>}
                            {journey.category === 2 && <div className="flex px-3 text-[#0F3E4A] bg-[#C8E7FF] border border-[#4FBAFF] hover:bg-[#bce1fe] duration-200 md:text-[12px] text-[9px]  font-bold rounded-[20px] py-1 cursor-pointer">Nơi ở</div>}
                            <div className="flex items-center gap-1">
                                <img width="25" height="25" src="https://img.icons8.com/fluency/48/price-tag--v1.png" alt="price-tag--v1" className="md:w-[25px] md:h-[25px] w-[20px] h-[20px]" />
                                <span className="md:text-[12px] text-[9px] ">150,000 VND</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <img width="30" height="30" src="https://img.icons8.com/keek/100/image.png" alt="image" className="md:w-[30px] md:h-[30px] w-[25px] h-[25px]" />
                                <span className="md:text-[12px] text-[9px]">2 ảnh</span>
                            </div>
                        </div>
