  ...
  return (
    <div className="relative">
      <input
        ...
        required={required}
        autoComplete="off"
        className={`mb-4 h-[40px] w-full rounded-[5px] border border-[#ccd0d5] bg-[#f5f6f7] px-3 shadow focus:outline-none ${
          error ? 'border-red-500' : 'border-[#ccd0d5] focus:border-blue-400'
        }`}
