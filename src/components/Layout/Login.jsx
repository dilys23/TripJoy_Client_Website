...
function Login() {
    ...
    return (
        <>
            ...
            <div className="fixed inset-0 flex w-full h-screen justify-center items-center text-center z-50">
                <div className="w-[604px] h-[600px] border-2 border-none rounded-xl shadow-xl stroke-2 bg-white stroke-[#D7D7D7] pt-2 flex flex-col items-center gap-y-5">
                    ...
                    <div className="underline text-[#818080] text-[20px] cursor-pointer">Quên mật khẩu?</div>
                    <div className="flex justify-between items-center  w-[490px]">
                        <div className="text-[#818080] text-[20px] cursor-pointer">Tạo tài khoản</div>
                        <button className="bg-[#13C892] text-white font-bold text-[24px] w-[191px] h-[55px] stroke-2
                         rounded-20  border-gray-100  shadow-md hover:bg-white hover:text-[#13C892] transition duration-500 ease-in-out ">
                            Đăng nhập
                        </button>
                    </div>
